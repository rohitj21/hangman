...
grid.arrange(draw_distribution("y_e"), draw_distribution("ap_"),draw_distribution("g_m"),
...
ggplot() + geom_bar(aes(x = 3:20, y = Prob_givenlength[3:20]) ,stat = "identity", fill = "darkolivegreen")+
    theme_light()+labs(x = "Word Length", y = "Probability",
